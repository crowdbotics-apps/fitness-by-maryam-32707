...
## Project Structure
    ...
    ├── fitness_by_maryam_32707  # Django project configurations
...
1. Clone this repo and `cd fitness_by_maryam_32707`
...
2. Clone this repo and `cd fitness_by_maryam_32707`
